...
//Icons
import iBrandR from '../assets/images/icon-brand-recognition.svg';
import iDetailedR from '../assets/images/icon-detailed-records.svg';
import iFullyC from '../assets/images/icon-fully-customizable.svg';
...
export const viewTemplate = () => {
    ...
    <nav class="relative container mx-auto p-6">
        ...
        <!-- Mobile Menu -->
        <div id="menu" class="absolute hidden p-6 rounded-lg bg-darkViolet left-6 right-6 top-20 z-40">
            <div class="flex flex-col items-center justify-center w-full space-y-6 font-bold text-white rounded-sm">
                ...
                <a href="#" class="w-full text-center border-t pt-4 border-gray-400">Login</a>
                <a href="#" class="w-full py-3 rounded-full text-center bg-cyan">Sign Up</a>
            </div>
        </div>
    </nav>
    <!-- Hero section -->
    <section id="hero">
        <div class="container flex flex-col-reverse mx-auto p-6 lg:flex-row">
            <!-- Content Container -->
                <div class="flex flex-col space-y-10 mb-44 lg:mt-16 lg:w1/2 xl:mb-52">
                    ...
                    <div class="mx-auto lg:mx-0">
                        <a href="#" class="py-5 px-10 text-2xl font-bold text-white bg-cyan rounded-full lg py-4 hover:opacity-70">
                            Get Started
                        </a>
                    </div>
                </div>
    ...
    <section id="shorten" class="relative bg-gray-100">
        ...
        <div class="max-w-4xl mx-auto p-6 space-y-6">
            ...
            <form id="link-form" class="relative flex flex-col w-full p-10 -mt-20 space-y-4 bg-darkViolet rounded-lg md:flex-row md:space-y-0 md:space-x-3">
                ...
                <button class="px-10 py-3 text-white bg-cyan rounded-lg hover:bg-cyanLight focus:outline-none md:py-2" type="submit">
                    Shorten It!
                </button>
                <!-- Error messages -->
        ...
        <div class="relative container flex flex-col items-start px-6 mx-auto md:flex-row md:space-x-7">
            ...
            <div class="relative flex flex-col p-6 space-y-6 bg-white rounded-lg md:w-1/3">
                ...
                <p class="text-center text-gray-400 md:text-left">
                    Boost your brand recognition with each click, Generic links don't men a thing. Branded links help insttil confidence in your content.
                </p>
            </div>
            <!-- Box 2 -->
            <div class="relative flex flex-col mt-24 p-6 space-y-6 bg-white rounded-lg md:mt-8 md:w-1/3">
                ...
                <p class="text-center text-gray-400 md:text-left">
                    Gain insights into whot is clicking your links. Knowing whten and where people engage with your content helps inform better decisions.
                </p>
            </div>
            <!-- Box 3 -->
    ...
    <footer class="py-16 bg-veryDarkViolet ">
        <div class="container flex flex-col items-center justify-between mx-auto space-y-16 md:flex-row md:space-y-0 md:items-start">
            ...
            <div class="flex space-x-6">
                <a href="https://github.com/Saul19-L98/tailwind_shortly" target="_blank" rel="noopener noreferrer">
                    <img src="${iGithub}" alt="#" class="ficon">
                </a>
                <a href="#">
                    <img src="${iPinterest}" alt="#" class="ficon">
                </a>
                <a href="#">
                    <img src="${iTwitter}" alt="#" class="ficon">
                </a><a href="#">
                    <img src="${iInstagram}" alt="#" class="ficon">
                </a>
            </div>
        </div>
    </footer>
